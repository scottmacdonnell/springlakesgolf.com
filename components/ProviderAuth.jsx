...
export default function ProviderAuth({ auth }) {
  return (
    <div className={styles.ProviderAuth}>
      <div className={styles.ProviderAuthGoogle}>
        <button onClick={(e) => auth.signInWithGoogle()}>
          <div className={styles.ProviderAuthGoogleGrid}>
            <GoogleLogo />

            <div className={styles.ProviderAuthGoogleText}>
      ...
      <div className={styles.ProviderAuthTwitter}>
        <button onClick={(e) => auth.signInWithTwitter()}>
          <div className={styles.ProviderAuthTwitterGrid}>
            <TwitterLogo />

            <div className={styles.ProviderAuthTwitterText}>
      ...
      <div className={styles.ProviderAuthFacebook}>
        <button onClick={(e) => auth.signInWithFacebook()}>
          <div className={styles.ProviderAuthFacebookGrid}>
            <FacebookLogo />

            <div className={styles.ProviderAuthFacebookText}>
...
function TwitterLogo() {
  return (
    <div className={styles.TwitterLogo}>
      <svg xmlns="http://www.w3.org/2000/svg" width="2443" height="2500" viewBox="0 0 248 204" preserveAspectRatio="xMidYMid">
      <g id="Logo_1_">
...
function FacebookLogo() {
  return (
    <div className={styles.FacebookLogo}>
      <svg xmlns="http://www.w3.org/2000/svg" width="2443" height="2500" viewBox="0 0 1024 1017.78" preserveAspectRatio="xMidYMid">
