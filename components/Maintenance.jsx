    ...
    <div className={styles.Maintenance}>
      <div className={styles.MaintenanceContainer}>
        ...
        <div className={styles.MaintenanceMain}>
          <p className={styles.Subtitle}>For any questions, please email:</p>
          <Link href="mailto:info@springlakesgolf.com">
            <a className={styles.MaintenanceEmail}><h3>info@springlakesgolf.com</h3></a>
          </Link>
        </div>

        <div className={styles.MaintenanceFooter}>
          <div className={styles.MaintenanceFooterTitle}>
            <h2 className={styles.Subtitle}>In the mean time, check out Spring Lakes Golf Club on social media!</h2>
          </div>

          <div className={styles.MaintenanceFooterGrid}>
            <div className={styles.MaintenanceFooterSocial}>
              <Social />
            </div>

            <div className={styles.MaintenanceFooterLogo}>
              <Logo />
            </div>
          </div>
        </div>
...
function Social() {
  return (
    <nav className={styles.Social}>
      <Link href="https://www.facebook.com/springlakesgolf">
        <a className="Link" target="_blank" rel="noopener noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
          <path fill="currentColor" d="M1024,512C1024,229.23016,794.76978,0,512,0S0,229.23016,0,512c0,255.554,187.231,467.37012,432,505.77777V660H302V512H432V399.2C432,270.87982,508.43854,200,625.38922,200,681.40765,200,740,210,740,210V336H675.43713C611.83508,336,592,375.46667,592,415.95728V512H734L711.3,660H592v357.77777C836.769,979.37012,1024,767.554,1024,512Z"/>
      ...
      <Link href="https://www.instagram.com/springlakesgolfclub/">
        <a className="Link" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.19995 19.19995">
            <path fill="currentColor" d="M13.898 7.051a1.656 1.656 0 0 0-.95-.949 2.766 2.766 0 0 0-.928-.172c-.527-.024-.685-.03-2.02-.03s-1.493.006-2.02.03a2.766 2.766 0 0 0-.929.172 1.656 1.656 0 0 0-.949.95 2.766 2.766 0 0 0-.172.928c-.024.527-.03.685-.03 2.02s.006 1.493.03 2.02a2.766 2.766 0 0 0 .172.929 1.656 1.656 0 0 0 .95.949 2.766 2.766 0 0 0 .928.172c.527.024.685.03 2.02.03s1.493-.006 2.02-.03a2.766 2.766 0 0 0 .929-.172 1.656 1.656 0 0 0 .949-.95 2.766 2.766 0 0 0 .172-.928c.024-.527.03-.685.03-2.02s-.006-1.493-.03-2.02a2.766 2.766 0 0 0-.172-.929zM10 12.568A2.568 2.568 0 1 1 12.568 10 2.568 2.568 0 0 1 10 12.568zm2.669-4.637a.6.6 0 1 1 .6-.6.6.6 0 0 1-.6.6z" transform="translate(-0.40002 -0.40002)"/>
            <circle fill="currentColor" cx="9.59998" cy="9.59998" r="1.66669"/>
            <path fill="currentColor" d="M10 .4a9.6 9.6 0 1 0 9.6 9.6A9.6 9.6 0 0 0 10 .4zm4.97 11.662a3.67 3.67 0 0 1-.233 1.213 2.556 2.556 0 0 1-1.462 1.462 3.67 3.67 0 0 1-1.213.233c-.534.024-.704.03-2.062.03s-1.528-.006-2.062-.03a3.67 3.67 0 0 1-1.213-.233 2.556 2.556 0 0 1-1.462-1.462 3.67 3.67 0 0 1-.233-1.213C5.006 11.528 5 11.358 5 10s.006-1.528.03-2.062a3.67 3.67 0 0 1 .233-1.213 2.556 2.556 0 0 1 1.462-1.462 3.67 3.67 0 0 1 1.213-.233C8.472 5.006 8.642 5 10 5s1.528.006 2.062.03a3.67 3.67 0 0 1 1.213.233 2.556 2.556 0 0 1 1.462 1.462 3.67 3.67 0 0 1 .233 1.213c.024.534.03.704.03 2.062s-.006 1.528-.03 2.062z" transform="translate(-0.40002 -0.40002)"/>
          </svg>
        </a>
      </Link>

      <Link href="https://twitter.com/SpringLakesGC">
        <a className="Link" target="_blank" rel="noopener noreferrer">
